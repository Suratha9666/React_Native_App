    ...
    return(
      ...
      <TextInput style={styles.inputbox} underlineColorAndroid='rgba(0,0,0,0)' placeholder='CardholderName' 
        ...
        <Text style={styles.inputbox2}> Selected {this.state.PickerValue}</Text>
         ...
         >
         <Picker.Item label="1.Workout" value="Workout" />
         <Picker.Item label="2.Swimming " value="Swimming" />
         
        
         <Picker.Item label="3.Yoga and Physiology" value="Yoga and Physiology" />
         <Picker.Item label="4.Breathe is life" value="Breathe is life" />
         <Picker.Item label="5.Power of healthy eating" value="Power of healthy eating" />
